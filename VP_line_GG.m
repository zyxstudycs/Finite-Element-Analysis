...
j=1;
for i=1:n
    if node_inf_RC(2,i)<node_inf_RC(3,i)+0.01 & node_inf_RC(2,i)>node_inf_RC(3,i)-0.01 & node_inf_RC(2,i)<0
...
j=1;
for i=1:n
    if node_inf_RF(2,i)<node_inf_RF(3,i)+0.01 & node_inf_RF(2,i)>node_inf_RF(3,i)-0.01 & node_inf_RF(2,i)<0
...
legend('Coarse','Fine');
title('Velocity potential in GG'); 
